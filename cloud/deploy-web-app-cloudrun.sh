...
# Deploy Doc Time Web App to Cloud Run
...
SERVICE_NAME="${SERVICE_NAME:-doctime-web-app}"
REGION="${GCP_REGION:-us-central1}"
IMAGE_NAME="gcr.io/${PROJECT_ID}/${SERVICE_NAME}"

echo "🚀 Deploying Doc Time Web App to Cloud Run..."
...
# Remove /api suffix if present (web-app api.js will add it if needed)
...
SERVICE_URL="https://doctime-web-app-${PROJECT_NUMBER}.${REGION}.run.app"

echo ""
echo "✅ Web app deployed successfully!"
echo "🌐 Service URL: $SERVICE_URL"
echo ""
echo "💡 The app is now running on Cloud Run with automatic scaling"
