...
// Change to backend directory to access node_modules before requiring
const backendDir = path.join(__dirname, '../backend');
process.chdir(backendDir);

// Now require modules from backend directory
...
const sequelize = new Sequelize(DATABASE_URL, {
  dialect: 'postgres',
  logging: false,
  dialectOptions: DATABASE_URL.includes('/cloudsql/') ? {} : {
    ssl: {
      require: true,
